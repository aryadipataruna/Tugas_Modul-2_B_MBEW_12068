...
model_path = r'C:\Users\Lenovo\Documents\kuliah\ML\Tugas_Modul 2_B_12068'
...
st.write("Aplikasi ini berguna untuk membantu mengenali potensi jantung pada manusia berusia 21 - 79 tahun")
Age = st.slider("Age",21,79)
Sex = st.selectbox("Gender",["F","M"])
ChestPainType = st.selectbox("Chest Paini Type",["ASY","ATA","NAP","TA"])
...
input_data = [[input_sex_F, input_sex_M, input_cpain_ASY,
               ...
               input_anginaN, input_anginaY, input_STSlope_down, input_STSlope_flat,
